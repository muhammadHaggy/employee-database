                ...
                <div className="relative bg-white rounded-lg shadow ">
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        ...
                        <form className="space-y-6" action="#">
                            ...
                            <button type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  :bg-blue-700 :ring-blue-800">Login to your account</button>
